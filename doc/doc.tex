...
In these experiments the values of the number of nodes in the system and their maximum degree has been varied to observe how it affects the connectivity of the network we obtained.
\begin{figure}[h!]
